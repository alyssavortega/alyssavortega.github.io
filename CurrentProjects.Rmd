...
<div class="projects"> 
  ...
  <p>A continuation of the Math Experts project, we are seeking non-correlation evidence of how proximity and having information accessible in our visual field can inspire "aha!" moments through self-generating insights. Participants come in person to the lab and solve 2 related puzzles in one of  3 conditions: close, far, or flexible. Those in the close condition are prevented from seeing the previous puzzle imagery while the far condition can easily access both and the flexible can chose their our method of proximity change. We predict those int he far and flexible conditions will solve the 2nd puzzle more often and faster than those in the close condition. Data collection is currently ongoing with a planned N = 160 </p>
